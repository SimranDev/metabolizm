...
// The unrefined field object is exported so consumers can .extend() it (the
// admin tool adds portions); the api validates with the refined schema below.
export const updateFoodFieldsSchema = z.object({
...
export const updateFoodSchema = updateFoodFieldsSchema.refine(
